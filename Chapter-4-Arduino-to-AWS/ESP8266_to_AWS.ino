 ...
 * SDK:2.2.1(cfd48f3)/Core:2.5.2-56-g403001e3=20502056/lwIP:STABLE-2_1_2_RELEASE
 *
 ...
 * certs obfuscated, use your own, but you can share root CA / x.509 until revoked
 */
...
const char* awsEndpoint = "<YOURACCOUNTID-ats.iot.REGION.amazonaws.com>"; 
