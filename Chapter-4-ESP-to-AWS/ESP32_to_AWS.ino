 ...
 * Sketch Modified by Stephen Borsay
 * https://github.com/sborsay
 * Add in Char buffer utilizing sprintf to dispatch JSON data to AWS IoT Core
 * Use and replace your own SID, PW, AWS Account Endpoint, Client cert, private cert
 * 
 * Contributors to AWS IoT Program for Arduino include those below:
 *
 * https://github.com/HarringayMakerSpace/awsiot
 * https://github.com/Ameba8195/Arduino/blob/master/hardware_v2/libraries/MQTTClient
 * examples/amazon_awsiot_basic/amazon_awsiot_basic.ino
 * https://github.com/igrr
 * https://github.com/copercini/esp32-iot-examples/blob/master/ESP32_aws_iot
...
vs4IBJbXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX6RR9dYGFHU
...
wtTyQfiBthpjKH64XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
...
void loop() {
  ...
  boolean rc = pubSubClient.publish(pubTopic, fakeData);
